...
class BankAccount:
    ...
    def withdraw(self, amount):
        ...
        to the transaction history, and return the new balance.
        """
        self.transactions.append(Transaction(len(self.transactions),self.balance,self.balance-amount if self.balance>=amount else self.balance))
...
class Coin:
    ...
    def worth(self):
        "*** YOUR CODE HERE ***"
        return self.cents+Mint.present_year-self.year-50 if Mint.present_year-self.year-50>0 else self.cents
