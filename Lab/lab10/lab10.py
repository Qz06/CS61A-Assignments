...
def floor_div(args):
    ...
    """
    "*** YOUR CODE HERE ***"
    first_operand=args.first
    rest_operand=args.rest
    while rest_operand:
        first_operand//=rest_operand.first
        rest_operand=rest_operand.rest
...
def eval_and(expressions):
    ...
    """
    "*** YOUR CODE HERE ***"
    check,val=expressions,scheme_t
    while check:
        val=calc_eval(check.first)
        if val is scheme_f:
            return scheme_f
        check=check.rest
    return val
